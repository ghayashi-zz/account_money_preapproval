...
class Meli {
    ...
    protected static $AUTH_URL     = "https://auth.mercadopago.com.br/authorization";
    ...
    protected $client_id = "8719661089596255";
    protected $client_secret = "9DGoTODNMnntDyTD375RwdG9DHX91J4Q";
    /*
    protected $client_id = "2907762493882925";
    protected $client_secret = "kQymp5u42g0IRxstLigEPxfUxMHiJ1RF";
    */
	...
	$access_token = $this->post('/oauth/token', $params, null, "application/x-www-form-urlencoded");
     ...
     * @return mixed
     */
    public function post($path, $body = null, $params = array(), $content_type = "application/json") {
	...
	if($content_type == 'application/x-www-form-urlencoded'){
        ...
        $opts = array(
            CURLOPT_HTTPHEADER => array('Accept: application/json', 'Content-Type: ' . $content_type),
            CURLOPT_POST => true, 
            CURLOPT_POSTFIELDS => $body
        );
